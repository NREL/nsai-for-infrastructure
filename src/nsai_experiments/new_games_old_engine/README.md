...
## alpha zero + grammar stuff, starting materials from Peter Graf
...
`srgame.py`
      ...
      This is a basic attempt to use our approach for symbolic regression. On a good day this has been able to find and fit quadratic data.  
      Note there is no just play mode for symbolic regression.
