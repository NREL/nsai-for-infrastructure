...
alpha zero + grammar stuff.  Here is some code to look at, and hopefully run.  Minimal summary of each file:

clean_4_Bowen/alphazero_grammar.py
...
clean_4_Bowen/transformer_encoder.py
